...
/* USER CODE BEGIN PV */
// RTOS synchronization objects (defined here, used by examples)
...
int main(void)
{
  ...
  /* Create synchronization objects for selected example */
  ...
  /* Create tasks for selected example */
  Examples_Init();
