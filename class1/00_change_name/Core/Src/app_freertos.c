...
void MX_FREERTOS_Init(void) {
  ...
  LED_TaskHandle = osThreadNew(Led_t, NULL, &LED_Task_attributes);

  /* creation of logger_task */
  logger_taskHandle = osThreadNew(Logger_t, NULL, &logger_task_attributes);
...
/* USER CODE BEGIN Header_Logger_t */
/**
* @brief Function implementing the logger_task thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Logger_t */
void Logger_t(void *argument)
{
